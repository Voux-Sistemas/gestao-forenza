...
export function MarcaForenza({ size = 30 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 44 44" fill="none" aria-hidden="true" style={{ display: "block", color: "var(--text)", flexShrink: 0 }}>
      <circle cx="22" cy="22" r="19" stroke="currentColor" strokeWidth="4.5" />
      <circle cx="22" cy="22" r="9.5" fill="var(--brand)" />
    </svg>
  );
}
